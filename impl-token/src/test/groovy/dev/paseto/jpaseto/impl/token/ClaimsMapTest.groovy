...
class ClaimsMapTest {
    ...
    void testToDateFromInvalidIso8601String() {
        ...
        def e = dev.paseto.jpaseto.impl.token.Util.expect(IllegalArgumentException, { ClaimsMap.toInstant(d.toString(), 'foo') })
    ...
    void testToDateFromNonDateObject() {
        ...
        def e = dev.paseto.jpaseto.impl.token.Util.expect IllegalStateException, { ClaimsMap.toInstant(value, 'foo') }
    ...
    void testGetClaimWithRequiredType_Exception() {
        ...
        def e = dev.paseto.jpaseto.impl.token.Util.expect RequiredTypeException, { m.get("anInteger", String.class) }
    ...
    void testGetClaimWithRequiredType_ShortWithBigInteger_Exception() {
        ...
        def e = dev.paseto.jpaseto.impl.token.Util.expect RequiredTypeException, { m.get("tooBigForShort", Short.class) }
    ...
    void testGetClaimWithRequiredType_ShortWithSmallInteger_Exception() {
        ...
        def e = dev.paseto.jpaseto.impl.token.Util.expect RequiredTypeException, { m.get("tooSmallForShort", Short.class) }
        assertThat e.getMessage(), is(String.format(ClaimsMap.CONVERSION_ERROR_MSG, 'class java.lang.Integer', 'class java.lang.Short'))
    }
    ...
    void testGetClaimWithRequiredType_ByteWithBigInteger_Exception() {
        ...
        def e = dev.paseto.jpaseto.impl.token.Util.expect RequiredTypeException, { m.get("tooBigForByte", Byte.class) }
    ...
    void testGetClaimWithRequiredType_ByteWithSmallInteger_Exception() {
        ...
        def e = dev.paseto.jpaseto.impl.token.Util.expect RequiredTypeException, { m.get("tooSmallForByte", Byte.class) }
        assertThat e.getMessage(), is(String.format(ClaimsMap.CONVERSION_ERROR_MSG, 'class java.lang.Integer', 'class java.lang.Byte'))
    }
